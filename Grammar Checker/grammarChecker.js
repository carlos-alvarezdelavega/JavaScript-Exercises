...
storyWords = storyWords.filter((word) => word != unnecessaryWord); //End reassigned variable

storyWords.forEach((word) => count++); // End .forEach() method
...
console.log(`-The 'bad' word's index is: ${badWordIndex}`);
